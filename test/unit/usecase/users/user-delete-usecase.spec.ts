...
describe('UserDeleteUseCase', () => {
  ...
  let deleteResultDtoInterface: DeleteResultDtoInterface = deleteResultDtoInterfaceMock
  ...
  describe('execute()', () => {
    describe('repository.findById()', () => {
      it('should return User model', async () => {
        expect(await userRepositoryInterface.findById(1)).toBe(userInterfaceMock)
      })
    })

    describe('repository.delete()', () => {
      it('should return DeleteResultDtoInterface', async () => {
        expect(await userRepositoryInterface.delete(1)).toBe(deleteResultDtoInterface)
      })
    })
  })
